...
import shiren1 from './shiren1.json'

// タイトル追加はここに import と games への追加を1行ずつ足すだけ(JSONは GameData スキーマに従うこと)
// 先頭がデフォルトのタイトル
export const games: GameData[] = [shiren6 as GameData, shiren5 as GameData, shiren4 as GameData, asuka as GameData, shiren1 as GameData]
